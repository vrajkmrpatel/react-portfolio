        ...
        ${
            ...
            >
                ...
                <button className="btn btn-primary">
                    Theme <FaChevronDown className="h-5 w-5" />
                </button>
                <ul className="menu dropdown-content z-[1] shadow-lg bg-base-100 rounded-box w-52 ">
                    <li>
                    ...
                    <li>
                        <button onClick={() => handleThemeChange("night")} className="btn w-full">Night</button>
                    </li>
                    <li>
                        <button onClick={() => handleThemeChange("synthwave")} className="btn w-full">Synthwave</button>
                    </li>
                    <li>
                    ...
                    <label className="btn btn-circle">
                        <Link to="https://github.com/vrajkmrpatel">
                            <svg
